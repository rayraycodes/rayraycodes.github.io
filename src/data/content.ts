    ...
    "stories": [
      {
        ...
        "title": "The Machines Keep Forgetting What We Are",
        "thumbnailTitle": "What We Are",
        "excerpt": "Computing keeps building for a tidy human who has never existed, and every few years the real, messy human walks back in. A reflection on the pattern, and what it asks of AI.",
        "date": "Jun 2026",
        "icon": "BookOpen",
        "theme": "teal",
        "content": {
          "description": [
            "Computing has a recurring dream. In the dream, the human is finally tidy. We answer messages promptly, rate things honestly on a scale of one to five, have preferences that hold still, and pursue our goals in straight lines. Every few years the industry builds something for that person. And every few years that person fails to show up, because that person has never existed.",
            "The real human is a different creature entirely. We are dramatic. We hold grudges over a text left on read. We buy the running shoes and do not run. We say \"I'm fine\" and mean six other things. We love people who are bad for us, cry at commercials, and check our phone for a message we know has not arrived. None of this is malfunction. This is the species working as designed. And computing's most expensive mistakes all come from treating that creature as a bug report.",
            "Look at how often we have run this exact experiment.",
            {
              "type": "quote",
              "text": "The tidy human has never existed. Every few years we build something for them anyway."
            },
            "The command line believed we were programmers. Early computing assumed the human would meet the machine on the machine's terms: memorize the syntax, type the incantation exactly, no typos forgiven. It worked for a priesthood and excluded everyone else. The correction was the graphical interface, and notice what it actually did. The desktop, the trash can, the folder, these were not technical advances. They were emotional ones. They let the machine speak in metaphors a human already felt at home with. The machine learned our language because we were never going to fully learn its.",
            "Plain text believed words were enough. Then in 1982, a computer scientist named Scott Fahlman noticed something breaking on message boards: jokes were landing as insults, because text had amputated tone of voice. His fix was three characters of punctuation, the first smiley. Think about what that moment really was. The medium deleted emotion, and humans immediately smuggled it back in through the keyboard. We have never stopped. Emoticons became emoji, emoji became reactions, then GIFs, then voice notes, then \"lol\" used not as laughter but as a softener, a tiny cushion we place under our sentences so they do not bruise. Every one of these is the same event: people forcing feeling back into a channel that tried to ship without it.",
            {
              "type": "figure",
              "url": "/assets/machines-feeling-timeline.svg",
              "alt": "A timeline of five markers, each a way users forced emotion back into text: the 1982 smiley, emoji in 1999, reactions, voice notes, and lol used as a cushion. The line is labelled the channel, shipped without feeling.",
              "caption": "Every marker is the same event: feeling, forced back in by the users themselves."
            },
            "That timeline is the user base, not the industry. Nobody at a company decided text needed feelings. Hundreds of millions of people decided it, one workaround at a time. When users consistently hack humanity back into your product, they are filing the most honest bug report there is.",
            "Software planning believed work was predictable. The Waterfall method assumed you could specify a system up front and march toward it like a factory order, as if the humans building it would not learn, change their minds, discover the spec was wrong, or burn out in month seven. Projects died by the thousands. The correction, the Agile movement, is remembered as a process change, but read its founding manifesto again: individuals and interactions over processes and tools, responding to change over following a plan. That is not project management language. That is someone admitting that software is made by moody, learning, talking creatures, and that any method denying this will be defeated by it.",
            "Social media believed connection was a number. This one is the heartbreak of the era, because it began with the right instinct. People crave each other; the platforms knew it. But then they handed the craving to an optimizer, and the optimizer did what optimizers do: it found the cheapest proxy. Connection became engagement. Friendship became a count. Being known became being seen, which became being measured. The like button turned affection into a metric, and the feed learned that outrage holds a gaze longer than tenderness does. The result is the strangest failure in computing history, a connection machine that left a generation lonelier than any before it. It did not fail by ignoring human nature. It failed by reading one page of it, the page about craving, and skipping the chapters about meaning.",
            {
              "type": "quote",
              "text": "A connection machine that left a generation lonelier than any before it. It read one page of us, and skipped the rest."
            },
            "Dating apps believed love was a matching problem. Sort by height, filter by hobby, swipe through humans like a catalog. And yet ask anyone how they actually fell in love and you will hear about timing, accident, a laugh at the wrong moment, someone who was not their type at all. The apps optimized the search and starved the serendipity, which is why so many users describe the experience as a second job. Love was never a retrieval task. It is a story, and stories need the unplanned.",
            "Even our self-improvement tools believed we were dashboards. Steps, streaks, sleep scores, a ring that grades your night and an app that scolds your sitting. The quantified self movement promised that to measure yourself was to know yourself. But a streak is not a reason to live, and a sleep score has made more than one person anxious enough to sleep worse. The number can tell you what you did. It cannot tell you what it meant, and meaning is the only fuel humans run on for long.",
            "Lay these side by side and the pattern is almost embarrassing in its consistency. Each system modeled a thin slice of the human, the slice that fits in a database, and treated the rest as noise. But the rest is not noise. The drama is how we signal what matters to us. The flaws are where our stories live. The emotions are data of the highest quality, information about value and threat and longing that no sensor fully captures. The connection is not a feature request, it is the load-bearing wall of a life. Strip those out and you have not simplified the human. You have lost the human, and kept the paperwork.",
            {
              "type": "quote",
              "text": "Strip out the mess and you do not get a simpler human. You lose the human, and keep the paperwork."
            },
            "Which brings us to AI, standing exactly where every one of these systems once stood, holding the most flattering mirror yet. The temptation now comes in two flavors. The crude one treats people as engagement to be maximized, and we already know how that story ends. The subtle one is more dangerous because it sounds like wisdom: it says emotion matters, so let us track it, score the mood, optimize the feelings too. That is not honoring the human. That is the fitness tracker pointed at the heart.",
            "The history points somewhere else. Every correction on this list worked the same way, by making room for the mess instead of cleaning it up. The GUI made room for intuition. The smiley made room for tone. Agile made room for changing your mind. The lesson for AI is not \"add an emotions module.\" It is something more like humility: build for the creature that actually exists. The one who needs to be understood more than analyzed, who heals in relationships and not in dashboards, whose flaws are not errors to patch but the texture of a person. An AI that reads your signals so a machine can manage you is the old mistake in its newest costume. An AI that helps the people who love you understand you, and then steps back, is the first one to read the whole book."
          ],
          "work": [],
          "impact": "We keep building for the tidy human and getting corrected by the real one. Forty years of smileys and workarounds and abandoned dashboards are the real human, patiently repeating the same message: I am not noise. At some point, the kindest and smartest thing a technology can do is believe us the first time.",
          "images": [
            {
              "url": "/assets/machines-metaphor-wave.svg",
              "alt": "A wave of three reductive metaphors of the human, each followed by a recovery, rising to AI today and a dotted path toward a new system that includes emotion, body, context, relationship, and meaning.",
              "caption": "Every recovery is a human walking back in."
            }
          ]
        }
      },
