    ...
    "stories": [
      {
        ...
        "excerpt": "We are standing in front of the most flattering mirror we have ever built and calling it AI. But we have been here before, at the wheel, the factory, the car, the feed. The machine was never the problem. How we choose to think about what a human is, and whether we take responsibility for it, is.",
        "date": "Jun 2026",
        "icon": "BookOpen",
        "theme": "teal",
        "content": {
          "description": [
            "Right now we are standing in front of the most flattering mirror we have ever built, and we are calling it artificial intelligence. It answers in our voice. It finishes our sentences. It tells us, in a hundred small ways, that it understands. And here is the move I want to catch us in the act of making, because we make it every single time something this powerful arrives: we say the feeling matters, the meaning matters, the human matters, and then we go and build as if none of that were our job to protect. We say the thing, and we do not stand behind it. That gap, between what we claim to value and what we actually choose to make, is the whole story.",
            "We are very good at hiding inside that gap, because we have somewhere to point. The algorithm radicalized him. The app made her anxious. The feed is addictive, the phone is the thief, the machine did it. Technology le sabbai garyo, we say where I come from. Technology did all of it. But a tool, left alone, does nothing at all. It does not want, it does not scheme, it does not even wake up. It is a mirror and a medium, and it carries forward exactly the thinking we hand it. Nothing the machine has ever done to us was done by the machine. We did it, through the machine, because of how we had already decided to think.",
            {
              "type": "quote",
              "text": "Technology, on its own, does nothing. We do."
            },
            "And if this moment feels new, it is only because we have short memories. We have stood at this exact edge before, every time we made something powerful enough to reshape us. The pattern is older than the computer, older than electricity, almost older than writing. So before I say one more word about AI, let me walk us back along the curve, because we have been rehearsing this for a very long time.",
            "It begins with something as plain as a wheel. We took the weight off our backs and rolled it, and the wheel flattened nothing about us. It carried what we could not. That is the promise sitting at the bottom of every tool we have ever made: be more of what you already are. We tend to forget that promise almost the moment we make it.",
            "Because then we built the factory, and we fell so hard for the machines that we tried to become them. We put ourselves on the line, timed our hands with a stopwatch, and renamed the human a unit of output. Worker as machine. It took decades and a famous accident of research to notice the obvious: when a group of workers simply felt watched, felt seen, they got better at the work no matter what we changed in the room. It was never the lighting. It was the attention. We had to discover, as if for the very first time, that a person is not an engine.",
            "Then we built the car and sold it stripped of all personality, any color you like so long as it is black, a sealed box of pure utility. And we, the people, could not bear it. We named our cars. We gave them fins and chrome and color and attitude. We turned an appliance into a love letter, a rebellion, a self. We took the thing shipped without a soul and we poured ours into it until it had one. Hold on to the shape of that, because we are about to do it again, faster.",
            {
              "type": "quote",
              "text": "Every time we ship something without a soul, we spend the next decade pouring ours back in."
            },
            "Bring it onto the screen and watch the loop spin quicker. We decided the human should be a programmer, and made people memorize incantations with no typo forgiven, a priesthood with everyone else locked outside. Then we got frustrated enough to apologize, and built the desktop, the folder, the trash can. Not breakthroughs. Apologies. We taught the machine to speak in metaphors we already lived inside, because we finally admitted we were never going to bend ourselves into its shape.",
            "We decided typed words were enough and amputated the tone from our own voices. Within hours of feeling the wound, back in 1982, we improvised a bandage out of punctuation, the first smiley. And we have never stopped bleeding the feeling back into the channel: emoji, reactions, GIFs, voice notes, lol worn smooth into a little cushion we slide under a sentence so it lands without a bruise.",
            {
              "type": "figure",
              "url": "/assets/machines-feeling-timeline.svg",
              "alt": "A timeline of five markers, each a way we forced emotion back into text: the 1982 smiley, emoji in 1999, reactions, voice notes, and lol used as a cushion. The line is labelled the channel, shipped without feeling.",
              "caption": "Every marker is the same move: us, forcing the feeling back in by hand."
            },
            "That timeline is not a company roadmap. It is hundreds of millions of us, each filing the same bug report against our own blueprint, one workaround at a time: you forgot the feeling, so we put it back by hand. And we kept finding fresh surfaces to make the same mistake on. We decided work was predictable and wrote plans that pretended the people doing the work would never learn or change their minds, until enough projects collapsed that we wrote ourselves a permission slip to be human and called it Agile. We decided connection was a number, handed our hunger for each other to an optimizer, and let it trade friendship for a count and tenderness for outrage.",
            {
              "type": "quote",
              "text": "We built a connection machine and ended up lonelier than ever. The machine did not do that. We did, by reading one page of ourselves and tearing out the rest."
            },
            "We decided love was a search problem and swiped through each other like a catalog, then fell for someone who was never our type, at the wrong time, mid-laugh, the way we always have. We decided we were dashboards and strapped on the steps and streaks and sleep scores, until the number meant to tell us who we are started telling us to sleep worse. Every time, the same error: we keep the slice of ourselves that fits in a database and throw the rest away as noise.",
            {
              "type": "quote",
              "text": "Strip out the mess and we do not get a simpler human. We lose the human and keep the paperwork."
            },
            "So here is the question I cannot put down, standing in front of this newest mirror. What is the curve actually optimizing away? Look at what falls off the edge every time we tighten the loop: the unplanned, the unmeasured, the inefficient, the slow. The body that knows things the mind cannot say. The context that decides what a sentence even means. The relationship that does the real healing. The meaning that is the only fuel we burn for long. Those are not the rounding errors. Those are the load-bearing walls, and an intelligence trained to maximize whatever is easy to count will, very politely, help us pave straight over them.",
            "That is where AI is standing right now. Not as a villain, but as the most persuasive amplifier of whatever we already believe a human to be. The crude temptation is the old one, farm people for engagement, and we know that ending. The subtle one arrives dressed as wisdom: feeling matters, it says, so let us measure the feeling too, score the mood, optimize the heart. That is not honoring the human. That is pointing the fitness tracker at the soul and calling it care.",
            "But the same history that indicts us also hands us the way out, because every recovery on this curve worked the same way: a human chose to make room for the mess instead of cleaning it up. We made room for intuition with the interface, for tone with the smiley, for our own changing minds with Agile. So the work I care about now is not bolting an emotions module onto a machine. It is changing the mind of the person who builds the machine. An empathetic technology does not study you so it can manage you better. It widens the space around you so the people who love you can understand you better, and then it has the grace to step back. That is the system some of us are trying to walk toward. The curve at the top of this page is the whole argument, and the dotted line is us, deciding."
          ],
          "work": [],
          "impact": "We keep building for a human who does not exist and getting corrected by the one who does. The wheel, the smiley, the abandoned dashboard, the whole curve is us arguing with our own assumptions: I am not noise. The machine was never the problem and it was never the cure. It is a mirror. The most honest thing I can do, as someone who builds, is take responsibility for what I think a human is, make room for the mess, and build technology that helps us understand each other instead of manage each other. That is the part that was always ours.",
          "images": [
            {
              "url": "/assets/machines-metaphor-wave.svg",
              "alt": "A wave of three reductive metaphors we imposed on the human, each followed by a recovery, rising to AI today and a dotted path toward a new way of thinking that includes emotion, body, context, relationship, and meaning.",
              "caption": "The peaks are the metaphors we imposed; the recoveries are us walking back in. AI is only the latest peak, and the dotted path is us, choosing to think differently."
            }
          ]
        }
      },
      ...
      },
      {
        ...
        "content": {
          "description": [
            ...
            "The shift has been from AI as assistant to AI as autonomous worker.",
